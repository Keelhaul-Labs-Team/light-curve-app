...
class ContainerNotificationPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StoreConnector<AppState, Option<Either<PublishFailure, PublishSucces>>>(
      distinct: true,
      ...
      onWillChange: (previousViewModel, newViewModel) {
        newViewModel.fold(() => {}, (failureOrSuccess) {
          failureOrSuccess.fold(
            ...
            (r) => showSnackBar(
                r.when(
                  loadSucces: () => 'Se cargó el video',
                  calculatedSucces: () => 'Se calculó con éxito',
                  uploadSucces: () => 'Se publicó con éxito',
                ),
                context,
                icon: Icons.check,
